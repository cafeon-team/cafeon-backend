...
class Store extends Model
{
    ...
    {
        return $this->hasMany(StoreBusinessHour::class)->orderBy('day_of_week');
    }
    ...
    {
        return $this->hasMany(StoreSeat::class);
    }
    ...
    public function noshowPolicy(): HasOne
    {
        return $this->hasOne(StoreNoshowPolicy::class);
    }
